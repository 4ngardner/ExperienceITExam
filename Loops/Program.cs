...
namespace Loops
{
    class Program
        ...
        static void Main(string[] args);
             ...
             Student.Add (FirstName = "Robert", LastName="Johnson" ),
             Student.Add (FirstName = "Nat", LastName="Jaffe" ),
            Student.Add (FirstName = "Jesse", LastName="Belvin" ),
        ...
        {
            //1. Write code tModify the Student class to provide a method to print each students name.
            // 3. Use the method from (2) to prio print all the names of all the studnets in the collection above.
            // 2. nt the students' names.
